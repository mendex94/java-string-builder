...
public class Program {
    public static void main(String[] args) {
        Post post_one = new Post(new Date(), "Traveling to New Zealand", "I'm going to visit this wonderful country!", 12);
        post_one.addComment(new Comment("Have a nice trip!"));
        post_one.addComment(new Comment("Wow that's awesome!"));

        Post post_two = new Post(new Date(), "Good night guys", "See you tomorrow", 5);
